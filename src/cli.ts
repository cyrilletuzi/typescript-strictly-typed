...
// oxlint-disable-next-line unicorn/prefer-top-level-await, oxlint-disable-next-line promise/prefer-await-to-then -- Top-level await not supported for bin cli
